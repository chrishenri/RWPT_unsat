...
!*************************************************************************************
  module global_variables
	 ...
	 integer,            parameter      :: nfnam = 17, nmaxmove = 10000000, iwscreen = 1
...
!*************************************************************************************
!  TRANSIENT PARAMETERS TIME DISCRETIZATION
!*************************************************************************************
 module trans_par_times
   implicit none
   save
   
   logical                  :: trans_flag                !T if any parameter other than MF2K fluxes is transient
   integer                  :: num_stp                   !number of time steps
   real*8, allocatable      :: transpar_times(:)         !time discretization vector
   logical                  :: transpar_switch = .TRUE. !True if parameters has to be updated
   integer                  :: transpar_it = 1           !index of time step
...
!*************************************************************************************
  module code_options
     ...
     save    
	 integer :: idebug
	 integer :: ixmom,irmom,itmom,iwbtc,iwcbtc,iwDbtc,iwcshot,idilut,iwpath
